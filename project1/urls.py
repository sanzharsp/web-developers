...
urlpatterns = [
    ...
    path('create-comment/<int:pk>',ProductDetailView.as_view(),name='create_comment'),

    path('create-child-comment/<int:pk>',create_child_comment,name='comment_child_create'),

    #Подгрузка комментария

    path('ajax_downolad_comment/<int:pk>/product_detail',views.ProductDetailView().ajax_downolad_comment,name='ajax_downolad_comment'),
